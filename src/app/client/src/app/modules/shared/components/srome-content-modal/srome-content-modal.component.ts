...
@Component({
  selector: 'app-srome-content-modal',
  templateUrl: './srome-content-modal.component.html',
  styleUrls: ['./srome-content-modal.component.scss']
})
export class SromeContentModalComponent implements OnInit {
